...
import { Phone, CheckCircle, Clock, DollarSign, ChevronDown } from 'lucide-react';
...
export function TradePage({ trade }: TradePageProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Schema Markup for SEO */}
      <TradeSchema trade={trade} />
      ...
      <section className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 text-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:py-24">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            {trade.display_name} Answering Service
          </h1>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-12 text-center">
            How RingByRing works for {trade.display_plural}
          </h2>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <DemoCTA trade={trade} variant="dark" />
        </div>
      </section>
      ...
      <section className="py-16 bg-emerald-600 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <DemoCTA trade={trade} variant="outline" />
          </div>
        </div>
      </section>
